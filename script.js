...
const perguntas = [
    {
        ...
        alternativas: [
            ...
            {
                texto: "Não!",
                afirmacao: "Recomendamos você a assistir, é uma série realmente boa!"
            }
        ]
    },
    {
        ...
        alternativas: [
            {
                texto: "Callie Torres e Arizona Robbins, Arizona Robbins.",
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "Meredith troca as fichas para que a Adele receba o Agente Ativo.",
                afirmacao: "Exatamente! E isso acabou levando a pesquisa para o seu fim."
            },
            {
